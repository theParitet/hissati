      ...
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-3 px-4 sm:px-6">
        ...
        <nav className="flex min-w-0 items-center gap-1">
          ...
          <button
            ...
            className="ms-1 inline-flex h-9 shrink-0 items-center gap-2 rounded-pill border border-sand-line bg-sand-100 px-3 text-sm font-medium leading-none text-ink transition-colors hover:bg-sand-200 focus-visible:outline-2 focus-visible:outline-offset-2"
...
function NavLink({
  ...
  return (
    <Link
      ...
      className={[
        "inline-flex h-9 shrink-0 items-center gap-1.5 rounded-pill px-2.5 text-sm font-medium leading-none transition-colors sm:px-3",
